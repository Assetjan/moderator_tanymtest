...
class GroupProvider extends ChangeNotifier {
  ...
  Future<void> _getCurrentUserSchoolId() async {
    try {
      ...
      if (user != null) {
        ...
        if (userDoc.exists) {
          schoolId = userDoc.get('school_id') as String;
          log(schoolId);
        }
      }
    } catch (e) {
      log("Error getting current user school_id: $e");
      throw e;
    }
  }
  ...
  Stream<List<GroupModel>> getGroups() {
    ...
    try {
      ...
      log("Error loading groups and students: $e");
      throw e;
    }
  }
  ...
  Future<void> registerStudent({
    ...
    try {
      ...
      log("Студент успешно зарегистрирован: $userId");
    } catch (e) {
      log("Ошибка при регистрации студента: $e");
